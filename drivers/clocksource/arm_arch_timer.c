...
static __always_inline int arch_timer_shutdown_access(const int access,
						      struct clock_event_device *clk)
{
	unsigned long ctrl;
...
{
	return arch_timer_shutdown_access(ARCH_TIMER_VIRT_ACCESS, clk);
}

static int arch_timer_shutdown_phys(struct clock_event_device *clk)
{
	return arch_timer_shutdown_access(ARCH_TIMER_PHYS_ACCESS, clk);
}

static int arch_timer_shutdown_virt_mem(struct clock_event_device *clk)
{
	return arch_timer_shutdown_access(ARCH_TIMER_MEM_VIRT_ACCESS, clk);
}

static int arch_timer_shutdown_phys_mem(struct clock_event_device *clk)
{
	return arch_timer_shutdown_access(ARCH_TIMER_MEM_PHYS_ACCESS, clk);
}
