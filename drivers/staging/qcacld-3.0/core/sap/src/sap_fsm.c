		...
		void *context)
{
	...
	case eSAP_START_BSS_EVENT:
		...
		bss_complete->status = (eSapStatus)(unsigned long) context;
	...
	case eSAP_DFS_NO_AVAILABLE_CHANNEL:
		...
		sap_ap_event.sapevt.sapStopBssCompleteEvent.status =
			(eSapStatus)(unsigned long) context;
		break;
	...
	case eSAP_ACS_CHANNEL_SELECTED:
		...
		if (eSAP_STATUS_SUCCESS == (eSapStatus)(unsigned long) context) {
		...
		} else if (eSAP_STATUS_FAILURE == (eSapStatus)(unsigned long) context) {
	...
	case eSAP_STA_REASSOC_EVENT:
		...
		reassoc_complete->status = (eSapStatus)(unsigned long) context;
	...
	case eSAP_STA_DISASSOC_EVENT:
		...
		disassoc_comp->status = (eSapStatus)(unsigned long) context;
	...
	case eSAP_STA_SET_KEY_EVENT:
		...
		key_complete->status = (eSapStatus)(unsigned long) context;
