...
{
	return iommu_debug_device_setup(&pdev->dev);
}

/*
 * We'll let the call to iommu_debug_destroy_tests() handle getting rid of
 * all the directories that were created.
 */
